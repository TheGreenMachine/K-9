...
public class SwerveKinematics {
    ...
    private static final Translation2d[] moduleRelativePositions =
        Constants.kModulePositions;
    private static final List<Translation2d> moduleRotationDirections = updateRotationDirections();

...
public class Constants {
    public static double kLooperDt = Robot.getFactory().getDouble("kLooperDt");
    public static final double kDriveWheelTrackWidthInches = Robot.getFactory().getDouble("trackWidth");
    public static final double kDriveWheelDiameterInches = Robot.getFactory().getDouble("wheelDiameter");
    ...
    // Canifier
    public static int kCanifierWristId = Robot.getFactory().getDouble("canifier", "canId").intValue();
    ...
    public static final double kMaxLookAheadSpeed = Robot.getFactory().getDouble("maxVel"); // inches per second
    ...
    public static final double kPathFollowingProfileKs = Robot.getFactory().getDouble("pathKs");;  // % throttle required to break static friction
